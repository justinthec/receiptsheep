...
function runOCR(inputFile, outputFile, next) {
    // Name of application you created
    var file = fs.readFileSync(__dirname + "/abbyycreds.txt","utf8");
    var appId = file.split('\n')[0];
    // Password should be sent to your e-mail after application was created
    var password = file.split('\n')[1];

    var imagePath = inputFile;
